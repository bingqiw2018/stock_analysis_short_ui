...
import { ChartTypeExchange } from './exchange.model';
...
const priceCandlestickChart: ChartTypeExchange = {
    series: [{
        data: [{
...
export { walletRadialChart, overviewChart, transactionsData, bitconinChart, ethereumChart, litecoinChart, priceCandlestickChart, notificationData };
