...
const jobViewChart: ChartObserved = {
    series: [{
        name: "Job View",
...
const ApplicationChart: ChartObserved = {
    series: [{
...
const ApprovedChart: ChartObserved = {
    series: [{
        name: "Total Approved",
...
const RejectedChart: ChartObserved = {
    series: [{
        name: "Total Rejected",
...
const emailSentBarChart: ChartObserved = {
    series: [{
        name: 'Companay',
        type: 'column',
...
// Received Time Data
const receivedTimeChart: ChartObserved = {
    series: [{
